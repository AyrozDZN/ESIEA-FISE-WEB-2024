<?php
require_once 'functions/model.php'; // Inclure la classe UserManager pour gérer les utilisateurs
...
$userManager = new UserManager(); // Instancier la classe UserManager
...
<main>
    <section>
        ...
        <?php
            ...
            $userInfo = $userManager->getUserInfos($userID); // Utiliser l'instance de UserManager
